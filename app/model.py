...
df_train_num = df_train[['year', 'selling_price', 'km_driven', 'mileage', 'engine', 'max_power']]
df_test_num = df_test[['year', 'selling_price', 'km_driven', 'mileage', 'engine', 'max_power']]
...
cat_cols_train = df_train[['fuel', 'seller_type', 'transmission', 'owner', 'seats']]
cat_cols_test = df_test[['fuel', 'seller_type', 'transmission', 'owner', 'seats']]
